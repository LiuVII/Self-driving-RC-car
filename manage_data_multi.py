...
def merge_sets(set1, set2, outset):
	...
	set1_img_path = img_dir + set1 + "/" + "left/"
	set2_img_path = img_dir + set2 + "/" + "left/"
	copytree(set1_img_path, img_dir + outset + "/left")
	copytree(set2_img_path, img_dir + outset + "/left")
	set1_img_path = img_dir + set1 + "/" + "right/"
	set2_img_path = img_dir + set2 + "/" + "right/"
	copytree(set1_img_path, img_dir + outset + "/right")
	copytree(set2_img_path, img_dir + outset + "/right")
